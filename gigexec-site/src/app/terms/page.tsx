  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-base text-gray-300 leading-relaxed space-y-6">
        ...
        <p>
          These Terms and Conditions ("Terms", "Terms and Conditions") govern your relationship with the GigExecs service operated by Perito Ventures LLC ("Service", "us", "we", or "our").
        </p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-4">1. Interpretation and Definitions</h2>
          
          <h3 className="text-lg font-semibold text-white mt-6 mb-2">Interpretation</h3>
          <p className="mb-4">
          ...
          <h3 className="text-lg font-semibold text-white mt-6 mb-2">Definitions</h3>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-4">2. Contact Us</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-4">3. Acknowledgment</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-4">6. Your Feedback to Us</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-4">7. Links to Other Websites</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-4">10. "AS IS" and "AS AVAILABLE" Disclaimer</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-4">12. Disputes Resolution</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-4">13. For European Union (EU) Users</h2>
          <p className="mb-4">
            If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in. Nothing in this Terms and Conditions is intended to affect Your rights as a consumer to rely on such mandatory provisions of local law.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-4">14. United States Legal Compliance</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-4">15. Severability and Waiver</h2>
          
          <h3 className="text-lg font-semibold text-white mt-6 mb-2">Severability</h3>
          <p className="mb-4">
            If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.
          </p>
          
          <h3 className="text-lg font-semibold text-white mt-6 mb-2">Waiver</h3>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-4">16. Translation Interpretation</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-4">17. Changes to These Terms and Conditions</h2>
          <p className="mb-4">
